...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : t(((e = e || self).poseDetection = {}), e.Pose, e.tf, e.tf);
  ...
  var u = [
    ...
    m = { runtime: "mediapipe", enableSmoothing: !0, modelType: "full" };
  var y = (function () {
    function e(e) {
      var i,
        n = this;
      switch (
        ...
        (this.poseSolution = new t.Pose({
          locateFile: function (t, i) {
            return e.solutionPath
              ? e.solutionPath.replace(/\/+$/, "") + "/" + t
              : i + "/" + t;
          },
        })),
        e.modelType)
      ...
      this.poseSolution.setOptions({
        ...
        this.poseSolution.onResults(function (e) {
          (n.height = e.image.height),
            ...
            null == e.poseLandmarks
              ? (n.poses = [])
              : (n.poses = [
                  n.translateOutput(e.poseLandmarks, e.poseWorldLandmarks),
                ]);
        });
    }
    return (
      (e.prototype.translateOutput = function (e, t) {
        var i = this,
          n = {
        ...
        return (
          null != t &&
            (n.keypoints3D = t.map(function (e, t) {
              return {
                x: e.x,
                y: e.y,
                z: e.z,
            ...
            switch (n.label) {
              case 0:
                return (
                  ...
                  [4, this.poseSolution.send({ image: e }, i)]
                );
              case 1:
      ...
      return l(this, function (n) {
        switch (n.label) {
          case 0:
            return (
              (t = (function (e) {
                if (null == e) return s({}, m);
                var t = s({}, e);
                return (
                  (t.runtime = "mediapipe"),
                  null == t.enableSmoothing &&
                    (t.enableSmoothing = m.enableSmoothing),
  ...
  function M(e, t, i) {
    var r = t.inputResolution,
      ...
      l = (function (e, t, i) {
        ...
        return (
          a > l
            ? ((o = e.width), (s = e.width * a), (h = (1 - l / a) / 2))
            : ((o = e.height / a), (s = e.height), (u = (1 - a / l) / 2)),
          (e.width = o),
          (e.height = s),
          { top: h, left: u, right: u, bottom: h }
        );
      })(a, r, o);
    return {
      imageTensor: n.tidy(function () {
          ...
          i = n.tensor2d(
            (function (e, t, i, n) {
              ...
              var r = 1 / t.width,
                ...
                p = e.height;
              return [
                (1 / n.width) * c * l * h * r * t.width,
                (1 / n.height) * -p * u * r * t.width,
                (-0.5 * c * l * h + 0.5 * p * u + s) * r * t.width,
                (1 / n.width) * c * u * h * o * t.height,
                (1 / n.height) * p * l * o * t.height,
                (-0.5 * p * l - 0.5 * c * u * h + a) * o * t.height,
                0,
                0,
              ];
            })(a, s, !1, r),
        ...
        return n.image.transform(
          n.expandDims(n.cast(t, "float32")),
          i,
          "bilinear",
          "nearest",
          0,
        ...
        (e.prototype.apply = function (e, t) {
          ...
          return (
            this.initialized
              ? (i =
                  null == t
                    ? this.storedValue + this.alpha * (e - this.storedValue)
                    : this.storedValue +
                      this.alpha * t * Math.asinh((e - this.storedValue) / t))
              : ((i = e), (this.initialized = !0)),
            (this.rawValue = e),
            (this.storedValue = i),
            i
          );
      ...
      return (
        (e.prototype.apply = function (e, t, i) {
          ...
          0 !== this.lastTimestamp &&
            0 !== n &&
            (this.frequency = 1 / (1e-6 * (n - this.lastTimestamp))),
            (this.lastTimestamp = n);
          var r = this.x.hasLastRawValue()
              ? (e - this.x.lastRawValue()) * i * this.frequency
              : 0,
      ...
      return (
        (e.prototype.apply = function (e, t, i) {
          ...
          if (!this.config.disableValueScaling) {
            if (i < this.config.minAllowedObjectScale) return e.slice();
            r = 1 / i;
          }
        ...
        (e.prototype.initializeFiltersIfEmpty = function (e) {
          var t = this;
          (null != this.xFilters && this.xFilters.length === e.length) ||
            ((this.xFilters = e.map(function (e) {
  ...
  function _(e, t) {
    return e.map(function (e) {
      var i = s({}, e, { x: e.x / t.width, y: e.y / t.height });
      ...
      return (
        (e.prototype.apply = function (e, t, i) {
          ...
          if (-1 === this.lastTimestamp) n = 1;
            ...
            for (
              var o = e * i - this.lastValue * this.lastValueScale,
                s = r - this.lastTimestamp,
                a = o,
                l = s,
                u = (1 + this.window.length) * (1e6 / 30),
                h = 0,
                c = this.window;
              h < c.length;
              h++
            ...
            (n = 1 - 1 / (1 + this.config.velocityScale * Math.abs(d))),
              this.window.unshift({ distance: o, duration: s }),
  ...
  var R = (function () {
    ...
    return (
      (e.prototype.apply = function (e, t, i, n, r) {
  ...
  function C(e, t) {
    var i = (function (e, t, i, n) {
      ...
      if (0 === r)
        throw new Error(
          "Original min and max are both " + e + ", range cannot be 0."
        );
      var s = o / r;
      return { scale: s, offset: i - e * s };
    })(0, 255, t[0], t[1]);
  ...
  function E(e, t, i) {
    var n = i.rotationVectorStartKeypointIndex,
      ...
      c = (function (e, t, i) {
        ...
        n = i.rotationVectorTargetAngle
          ? i.rotationVectorTargetAngle
          : (Math.PI * i.rotationVectorTargetAngleDegree) / 180;
  ...
  function I(e, t) {
    return n.tidy(function () {
      var i = (function (e) {
        ...
        r = i[0],
        o = i[1];
      return { boxes: n.squeeze(o), scores: n.squeeze(r) };
    });
  }
  function B(e) {
    for (
      var t = { locationData: { relativeKeypoints: [] } },
      ...
      (i = Math.min(i, a.x)),
        ...
        (r = Math.min(r, a.y)),
        (o = Math.max(o, a.y)),
        t.locationData.relativeKeypoints.push({ x: a.x, y: a.y });
    }
    return (
      (t.locationData.relativeBoundingBox = {
        xMin: i,
        yMin: r,
        xMax: n,
        yMax: o,
    ...
    return a(this, void 0, void 0, function () {
      ...
      return l(this, function (l) {
        switch (l.label) {
              ...
              (s = (function (e, t, i) {
                return n.tidy(function () {
                  ...
                  i.reverseOutputOrder
                    ? ((o = n.squeeze(
                        n.slice(e, [0, i.boxCoordOffset + 0], [-1, 1])
                      )),
                      (r = n.squeeze(
                        n.slice(e, [0, i.boxCoordOffset + 1], [-1, 1])
                      )),
                      (a = n.squeeze(
                        n.slice(e, [0, i.boxCoordOffset + 2], [-1, 1])
                      )),
                      (s = n.squeeze(
                        n.slice(e, [0, i.boxCoordOffset + 3], [-1, 1])
                      )))
                    : ((r = n.squeeze(
                        n.slice(e, [0, i.boxCoordOffset + 0], [-1, 1])
                      )),
                    ...
                    i.applyExponentialOnBoxSize
                      ? ((s = n.mul(n.exp(n.div(s, i.hScale)), t.h)),
                        (a = n.mul(n.exp(n.div(a, i.wScale)), t.w)))
                      : ((s = n.mul(n.div(s, i.hScale), t.h)),
                  ...
                  if (i.numKeypoints)
                    for (var d = 0; d < i.numKeypoints; ++d) {
                      var f =
                        ...
                        y = void 0;
                      i.reverseOutputOrder
                        ? ((m = n.squeeze(n.slice(e, [0, f], [-1, 1]))),
                          (y = n.squeeze(n.slice(e, [0, f + 1], [-1, 1]))))
                        : ((y = n.squeeze(n.slice(e, [0, f], [-1, 1]))),
          ...
          case 1:
            return (u = l.sent()), n.dispose([s, a]), [2, u];
        }
      });
    });
  }
    ...
    return a(this, void 0, void 0, function () {
      ...
      return l(this, function (l) {
        switch (l.label) {
          ...
          case 2:
            for (o = l.sent(), s = 0; s < i.numBoxes; ++s)
              if (
                !(
                  (null != i.minScoreThresh && o[s] < i.minScoreThresh) ||
                  ((a = s * i.numCoords),
                  (u = D(
                    r[a + 0],
                    r[a + 1],
    ...
    return (
      ...
      a(this, void 0, void 0, function () {
        ...
        return l(this, function (l) {
          switch (l.label) {
            case 0:
              return (r = e.size), (o = r / t.numLandmarks), [4, e.data()];
            case 1:
              for (s = l.sent(), a = [], u = 0; u < t.numLandmarks; ++u)
                (h = u * o),
                  ((p = { x: 0, y: 0 }).x = i
                    ? t.inputImageWidth - s[h]
                    : s[h]),
                  o > 1 && (p.y = n ? t.inputImageHeight - s[h + 1] : s[h + 1]),
                  o > 2 && (p.z = s[h + 2]),
                  o > 3 && (p.score = ((d = s[h + 3]), 1 / (1 + Math.exp(-d)))),
                  a.push(p);
  ...
  function j(e, t, i) {
    var n = e.width,
      ...
      o = e.rotation;
    if (
      ((null == i.rotation && null == i.rotationDegree) ||
        (o = (function (e, t) {
          null != t.rotation
            ? (e += t.rotation)
            : null != t.rotationDegree &&
              (e += (Math.PI * t.rotationDegree) / 180);
          return x(e);
        })(o, i)),
      0 === o)
    )
      ...
      var s =
          (t.width * n * i.shiftX * Math.cos(o) -
            t.height * r * i.shiftY * Math.sin(o)) /
          t.width,
        a =
          (t.width * n * i.shiftX * Math.sin(o) +
            t.height * r * i.shiftY * Math.cos(o)) /
          t.height;
      (e.xCenter = e.xCenter + s), (e.yCenter = e.yCenter + a);
    }
    if (i.squareLong) {
  ...
  var H = (function () {
      ...
      return (
        (e.prototype.apply = function (e) {
          ...
          (null != this.visibilityFilters &&
            this.visibilityFilters.length === e.length) ||
            (this.visibilityFilters = e.map(function (e) {
    ...
    G = -1,
    Q = 0.3,
    Z = { shiftX: 0, shiftY: 0, scaleX: 1.25, scaleY: 1.25, squareLong: !0 },
    $ = { inputResolution: { width: 224, height: 224 }, keepAspectRatio: !0 },
    J = { inputResolution: { width: 256, height: 256 }, keepAspectRatio: !0 },
    ee = { numLandmarks: 39, inputImageWidth: 256, inputImageHeight: 256 },
    te = { numLandmarks: 39, inputImageWidth: 1, inputImageHeight: 1 },
    ie = { kernelSize: 7, minConfidenceToRefine: 0.5 },
    ne = { alpha: 0.1 },
    re = {
      oneEuroFilter: {
        frequency: 30,
  ...
  var ae = (function () {
    function e(e, t, i, r) {
      (this.detectorModel = e),
        ...
        (this.anchors = (function (e) {
          for (var t = [], i = 0; i < e.numLayers; ) {
            for (
              var n = [], r = [], o = [], s = [], a = i;
              a < e.strides.length && e.strides[a] === e.strides[i];
              ...
              if (0 === a && e.reduceBoxesInLowestLayer)
                ...
                for (var u = 0; u < e.aspectRatios.length; ++u)
                  o.push(e.aspectRatios[u]), s.push(l);
                if (e.interpolatedScaleAspectRatio > 0) {
                  var h =
                    a === e.strides.length - 1
                      ? 1
                      : A(e.minScale, e.maxScale, a + 1, e.strides.length);
            ...
            if (e.featureMapHeight.length > 0)
              (d = e.featureMapHeight[i]), (f = e.featureMapWidth[i]);
            else {
              var m = e.strides[i];
      ...
      this.anchorTensor = { x: a, y: l, w: o, h: s };
    }
    return (
      (e.prototype.estimatePoses = function (e, t, i) {
        return a(this, void 0, void 0, function () {
          ...
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return (
                  (r = (function (e) {
                    var t;
                    if (
                      (null == (t = null == e ? W : s({}, e)).maxPoses &&
                        (t.maxPoses = 1),
                      t.maxPoses <= 0)
                    )
                      throw new Error(
                        "Invalid maxPoses " + t.maxPoses + ". Should be > 0."
                      );
                    if (t.maxPoses > 1)
                      throw new Error(
              ...
              case 1:
                ...
                (p = c[0]), (u = this.poseDetectionToRoi(p, o)), (l.label = 2);
              case 2:
                ...
                return (
                  ...
                  null == d
                    ...
                    : ((f = d.actualLandmarks),
                      ...
                      [2, [{ score: y, keypoints: P, keypoints3D: _ }]])
                );
            }
          });
        });
                  ...
                  (c = (function (e, t) {
                    ...
                    for (
                      ...
                      var a = e[s],
                        ...
                        c = l.width / (1 - r),
                        p = l.height / (1 - o);
                      (l.xMin = u), (l.yMin = h), (l.width = c), (l.height = p);
                      for (
                        var d = 0;
                        d < a.locationData.relativeKeypoints.length;
                        ++d
                      ) {
            ...
            switch (l.label) {
              case 0:
                if (
                  ...
                  throw new Error(
                    "Model type must be one of lite, full or heavy,but got " +
                      this.modelType
                  );
                return (
                  (u = this.landmarkModel.execute(a, [
                    "ld_3d",
                    "output_poseflag",
                    "activation_heatmap",
                    "world_3d",
              ...
              case 1:
                return (f = l.sent()[0]) < 0.5
                  ? (n.dispose(u), n.dispose([r, a]), [2, null])
                  : [4, K(h, ee)];
              case 2:
      ...
      (e.prototype.poseLandmarkFiltering = function (e, t, i, n) {
        ...
        if (null != this.timestamp && this.enableSmoothing) {
          ...
          null == this.visibilitySmoothingFilterActual &&
            (this.visibilitySmoothingFilterActual = new H(ne)),
            (r = this.visibilitySmoothingFilterActual.apply(e)),
            null == this.visibilitySmoothingFilterAuxiliary &&
              (this.visibilitySmoothingFilterAuxiliary = new H(ne)),
            ...
            null == this.landmarksSmoothingFilterActual &&
              (this.landmarksSmoothingFilterActual = new R(re)),
            ...
            null == this.landmarksSmoothingFilterAuxiliary &&
              (this.landmarksSmoothingFilterAuxiliary = new R(oe)),
            ...
            null == this.worldLandmarksSmoothingFilterActual &&
              (this.worldLandmarksSmoothingFilterActual = new R(se)),
            (s = this.worldLandmarksSmoothingFilterActual.apply(
              i,
              this.timestamp
            ));
        } else (r = e), (o = t), (s = i);
          ...
          case 0:
            return (
              (t = (function (e) {
                ...
                if (
                  (null == t.enableSmoothing &&
                    (t.enableSmoothing = X.enableSmoothing),
                  null == t.modelType && (t.modelType = X.modelType),
                  null == t.detectorModelUrl &&
                    (t.detectorModelUrl = X.detectorModelUrl),
              ...
              [
                4,
                Promise.all([
                  i.loadGraphModel(t.detectorModelUrl, { fromTFHub: n }),
                  i.loadGraphModel(t.landmarkModelUrl, { fromTFHub: r }),
                ]),
              ]
            );
          case 1:
    ...
    ce = (function () {
      function e(e) {
        !(function (e) {
          if (e.maxTracks < 1)
            throw new Error(
              "Must specify 'maxTracks' to be at least 1, but encountered " +
                e.maxTracks
            );
          if (e.maxAge <= 0)
            throw new Error(
              "Must specify 'maxAge' to be positive, but encountered " +
                e.maxAge
            );
          if (void 0 !== e.keypointTrackerParams) {
            if (
              e.keypointTrackerParams.keypointConfidenceThreshold < 0 ||
              e.keypointTrackerParams.keypointConfidenceThreshold > 1
            )
              throw new Error(
            ...
            if (e.keypointTrackerParams.minNumberOfKeypoints < 1)
              throw new Error(
                "Must specify 'minNumberOfKeypoints' to be at least 1, but encountered " +
                  e.keypointTrackerParams.minNumberOfKeypoints
              );
            for (
              var t = 0, i = e.keypointTrackerParams.keypointFalloff;
              t < i.length;
              t++
            ) {
              var n = i[t];
              if (n <= 0)
                throw new Error(
                  "Must specify each keypoint falloff parameterto be positive but encountered " +
                    n
                );
            }
          }
      ...
      return (
        ...
        (e.prototype.assignTracks = function (e, t, i) {
          for (
            var n = Array.from(Array(t[0].length).keys()),
              r = [],
              o = 0,
              s = Array.from(Array(e.length).keys());
            o < s.length;
            o++
          ) {
            var a = s[o];
          ...
          for (var y = 0, g = r; y < g.length; y++) {
            ...
            this.tracks.push(v), (e[a].id = v.id);
          }
        }),
        ...
        (e.prototype.createTrack = function (e, t, i) {
          ...
          return void 0 !== e.box && (n.box = s({}, e.box)), n;
        }),
    ...
    pe = (function (e) {
      ...
      return (
        ...
        (t.prototype.iou = function (e, t) {
          ...
          var s = (r - i) * (o - n);
          return (
            s / (e.box.width * e.box.height + t.box.width * t.box.height - s)
          );
        }),
        t
      );
    ...
    de = (function (e) {
      ...
      return (
        ...
        (t.prototype.oks = function (e, t) {
          for (
            var i = this.area(t.keypoints) + 1e-6, n = 0, r = 0, o = 0;
            o < e.keypoints.length;
            ++o
          ) {
            var s = e.keypoints[o],
              a = t.keypoints[o];
  ...
  var me = Object.freeze({
    ...
    ge = { modelType: "SinglePose.Lightning", enableSmoothing: !0 },
    ve = {},
    xe = {
      frequency: 30,
      minCutOff: 2.5,
    ...
    ke = { maxTracks: 18, maxAge: 1e3, minSimilarity: 0.15, trackerParams: {} };
  function Me(e, t, i, n) {
    ...
    if (
      (function (e, t) {
        return (
          (e[t.left_hip].score > 0.2 || e[t.right_hip].score > 0.2) &&
          (e[t.left_shoulder].score > 0.2 || e[t.right_shoulder].score > 0.2)
        );
      })(t, i)
    ) {
      var l = (r.left_hip[0] + r.right_hip[0]) / 2,
        ...
        g = [
          l - (y = Math.min(y, Math.max(h, n.width - h, l, n.height - l))),
          h - y,
        ];
      if (y > Math.max(n.width, n.height) / 2) return be(null == e, n);
      var v = 2 * y;
      return {
        yMin: g[0] / n.height,
        xMin: g[1] / n.width,
    ...
    return (
      e
        ...
        : ((i = 1),
          ...
          (r = 0),
          (o = (t.width / 2 - t.height / 2) / t.width)),
      { yMin: r, xMin: o, yMax: r + i, xMax: o + n, height: i, width: n }
    );
  }
  function Se(t) {
    var i,
    ...
    if (null == n.modelType) n.modelType = "SinglePose.Lightning";
      ...
      throw new Error(
        "Invalid architecture " + n.modelType + ". Should be one of " + ye
      );
    if (
      (null == n.enableSmoothing && (n.enableSmoothing = !0),
      null != n.minPoseScore && (n.minPoseScore < 0 || n.minPoseScore > 1))
    )
      throw new Error("minPoseScore should be between 0.0 and 1.0");
    if (
      null != n.multiPoseMaxDimension &&
      (n.multiPoseMaxDimension % 32 != 0 ||
        n.multiPoseMaxDimension < 128 ||
        n.multiPoseMaxDimension > 512)
    )
      throw new Error(
        "multiPoseResolution must be a multiple of 32 and between 128 and 512"
      );
    if (
      ("MultiPose.Lightning" === n.modelType &&
        null == n.enableTracking &&
        (n.enableTracking = !0),
      "MultiPose.Lightning" === n.modelType && !0 === n.enableTracking)
    )
      if (
        (null == n.trackerType && (n.trackerType = e.TrackerType.BoundingBox),
        n.trackerType === e.TrackerType.Keypoint)
      )
        null != n.trackerConfig
          ? (n.trackerConfig = (function (e) {
              var t = Te(we, e);
              (t.keypointTrackerParams = s({}, we.keypointTrackerParams)),
                null != e.keypointTrackerParams &&
                  (null !=
                    ...
                    (t.keypointTrackerParams.keypointConfidenceThreshold =
                      e.keypointTrackerParams.keypointConfidenceThreshold),
                  null != e.keypointTrackerParams.keypointFalloff &&
                    (t.keypointTrackerParams.keypointFalloff =
                      e.keypointTrackerParams.keypointFalloff),
                  null != e.keypointTrackerParams.minNumberOfKeypoints &&
        ...
        null != n.trackerConfig
          ? (n.trackerConfig = ((i = n.trackerConfig), Te(ke, i)))
          : (n.trackerConfig = ke);
      }
    return n;
  }
  function Te(e, t) {
    ...
    return (
      null != t.maxTracks && (i.maxTracks = t.maxTracks),
  ...
  var Pe = (function () {
    function t(t, i) {
      (this.moveNetModel = t),
        ...
        this.multiPoseModel ||
          ((this.keypointFilter = new P(xe)),
          (this.cropRegionFilterYMin = new S(0.9)),
          (this.cropRegionFilterXMin = new S(0.9)),
          (this.cropRegionFilterYMax = new S(0.9)),
          (this.cropRegionFilterXMax = new S(0.9))),
        (this.enableSmoothing = i.enableSmoothing),
        i.minPoseScore
          ? (this.minPoseScore = i.minPoseScore)
        ...
        this.multiPoseModel &&
          this.enableTracking &&
          (i.trackerType === e.TrackerType.Keypoint
            ? (this.tracker = new de(i.trackerConfig))
            : i.trackerType === e.TrackerType.BoundingBox &&
              (this.tracker = new pe(i.trackerConfig)),
          this.enableSmoothing && (this.keypointFilterMap = new Map()));
    }
    return (
      (t.prototype.runSinglePersonPoseModel = function (e) {
        return a(this, void 0, void 0, function () {
          var t, i, r, o, s;
          return l(this, function (a) {
            switch (a.label) {
              case 0:
                if (
                  4 !== (t = this.moveNetModel.execute(e)).shape.length ||
                  1 !== t.shape[0] ||
                  1 !== t.shape[1] ||
                  17 !== t.shape[2] ||
                  3 !== t.shape[3]
                  ...
                  throw (
                    (t.dispose(),
                    new Error(
                      "Unexpected output shape from model: [" + t.shape + "]"
                    ))
                  );
              ...
              case 3:
                for (
                  t.dispose(), r = { keypoints: [], score: 0 }, o = 0, s = 0;
                  s < 17;
                  ++s
                )
                  (r.keypoints[s] = {
                    ...
                    r.keypoints[s].score > 0.2 &&
                      (++o, (r.score += r.keypoints[s].score));
        ...
        return a(this, void 0, void 0, function () {
          ...
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                if (
                  3 !== (t = this.moveNetModel.execute(e)).shape.length ||
                  1 !== t.shape[0] ||
                  56 !== t.shape[2]
                )
                  throw (
              ...
              case 2:
                (i = l.sent()), (l.label = 3);
              case 3:
                for (t.dispose(), r = [], o = i.length / 56, s = 0; s < o; ++s)
                  for (
                    r[s] = { keypoints: [] },
                      a = 56 * s + 51,
                      r[s].box = {
          ...
          return l(this, function (l) {
            switch (l.label) {
              case 0:
                return (
                  this.cropRegion ||
                    (this.cropRegion = be(null == this.cropRegion, t)),
                  (r = n.tidy(function () {
                    var t = n.tensor2d([
                        [
                          u.cropRegion.yMin,
                    ...
                    return n.cast(
                      n.image.cropAndResize(e, t, i, r, "bilinear", 0),
                      "int32"
                    );
                  })),
                  e.dispose(),
              ...
              case 1:
                ...
                for (s = 0; s < o.keypoints.length; ++s)
                  (o.keypoints[s].y =
                    ...
                    o.keypoints[s].y * this.cropRegion.height),
                    (o.keypoints[s].x =
                      this.cropRegion.xMin +
                      o.keypoints[s].x * this.cropRegion.width);
                return (
                  null != i &&
                ...
                return (
                  ...
                  t.width > t.height
                    ? ((o = this.multiPoseMaxDimension),
                      (s = Math.round(
                        (this.multiPoseMaxDimension * t.height) / t.width
                      )),
                    ...
                    : ((o = Math.round(
                        (this.multiPoseMaxDimension * t.width) / t.height
                      )),
                ...
                if (
                  ...
                  for (f = 0; f < p.length; ++f)
                    this.keypointFilterMap.has(p[f].id) ||
                      this.keypointFilterMap.set(p[f].id, new P(xe)),
          ...
          switch (a.label) {
            case 0:
              return (
                ...
                (o = !0),
                t.modelUrl
                  ? ((o = t.modelUrl.indexOf("https://tfhub.dev") > -1),
                    [4, i.loadGraphModel(t.modelUrl, { fromTFHub: o })])
                  : [3, 2]
              );
            case 1:
              return (r = a.sent()), [3, 4];
  ...
  var Fe = {
    ...
    ze = { MobileNetV1: [8, 16], ResNet50: [16] },
    Re = [8, 16, 32],
    Ce = { MobileNetV1: [0.5, 0.75, 1], ResNet50: [1] },
    Ee = [1, 2, 4],
    Ae = { maxPoses: 1, flipHorizontal: !1 },
    Ie = {
      maxPoses: 5,
      flipHorizontal: !1,
      scoreThreshold: 0.5,
    ...
    return (
      ...
      (e.prototype.swim = function (e) {
        for (; e > 0 && this.less(Ne(e), e); )
          this.exchange(e, Ne(e)), (e = Ne(e));
      }),
      (e.prototype.sink = function (e) {
        for (; 2 * e <= this.numberOfElements; ) {
          var t = 2 * e;
          if (
            (t < this.numberOfElements && this.less(t, t + 1) && t++,
            !this.less(e, t))
          )
            break;
  ...
  function Ve(e, t, i, n, r, o) {
    for (
      ...
      for (
        var d = Math.max(n - r, 0), f = Math.min(n + r + 1, l), m = d;
        m < f;
        ++m
      )
        if (o.get(p, m, e) > t) {
  ...
  function De(e, t, i, n) {
    return { y: n.get(e, t, i), x: n.get(e, t, i + 17) };
  }
  function Ke(e, t, i) {
    var n = De(e.heatmapY, e.heatmapX, e.id, i),
      r = n.y,
      o = n.x;
    return { x: e.heatmapX * t + o, y: e.heatmapY * t + r };
  }
  function je(e, t, i, n) {
    var r = i.x,
      o = i.y;
    ...
    for (
      var l = n.shape,
        ...
        d = Qe(
          ...
          (function (e, t, i) {
            var n = i.shape[2] / 2;
            return { y: i.get(t.y, t.x, e), x: i.get(t.y, t.x, n + e) };
          })(e, Ge(p, o, h, c), s)
        ),
        f = 0;
      f < a;
      ...
      var m = Ge(d, o, h, c),
        y = De(m.y, m.x, i, r);
      d = Qe({ x: m.x * o, y: m.y * o }, { x: y.x, y: y.y });
    }
    var g = Ge(d, o, h, c),
      v = n.get(g.y, g.x, i);
    return { y: d.y, x: d.x, name: u[i], score: v };
  }
  function $e(e, t, i, n, r, o) {
    var s = t.shape[2],
      ...
      c = e.score,
      p = Ke(h, n, i);
    l[h.id] = { score: c, name: u[h.id], y: p.y, x: p.x };
    for (var d = a - 1; d >= 0; --d) {
      var f = Xe[d],
        m = We[d];
  ...
  function Je(e, t, i) {
    return (
      i.reduce(function (i, n, r) {
        var o = n.y,
          s = n.x,
          a = n.score;
        return je(e, t, { y: o, x: s }, r) || (i += a), i;
      }, 0) / i.length
    );
  }
                        ...
                        for (var h = 0; h < s; ++h) {
                          ...
                          c < e ||
                            (Ve(h, c, l, u, t, i) &&
                              a.enqueue({
                                score: c,
                                part: { heatmapY: l, heatmapX: u, id: h },
                              }));
                        }
                    return a;
                  })(s, 1, h),
  ...
  function tt(e) {
    ...
    return n.tidy(function () {
      var t,
        ...
        a = n.reshape(e, [i * r, o]),
        l = n.argMax(a, 0),
        u = n.expandDims(n.div(l, n.scalar(r, "int32")), 1),
        h = n.expandDims(
          ((t = l),
          (s = r),
          n.tidy(function () {
  ...
  function it(e, t, i) {
    return n.tidy(function () {
      ...
      return n.add(
        n.cast(n.mul(e.toTensor(), n.scalar(t, "int32")), "float32"),
        r
      );
    });
  }
  function nt(e, t, i, n) {
    return { y: n.get(e, t, i), x: n.get(e, t, i + u.length) };
  }
  function rt(e, t, i) {
    return a(this, void 0, void 0, function () {
          ...
          case 2:
            return (
              ...
              (d = Array.from(
                (function (e, t) {
                  for (
                    var i = t.shape[0], n = new Float32Array(i), r = 0;
                    r < i;
                    r++
                  ) {
                    var o = t.get(r, 0),
              ...
              (f = d.map(function (e, t) {
                return (
                  (n += e),
                  { y: p.get(t, 0), x: p.get(t, 1), score: e, name: u[t] }
                );
              })),
              r.dispose(),
              c.dispose(),
              [2, { keypoints: f, score: n / f.length }]
            );
        }
      });
    });
  ...
  var ut = (function () {
    function e(e, t) {
      ...
      n.util.assert(-1 === i[1] && -1 === i[2], function () {
        return (
          "Input shape [" + i[1] + ", " + i[2] + "] must both be equal to or -1"
        );
      });
      var r,
        o,
        s =
          ((r = t.inputResolution),
          (o = t.outputStride),
          { height: lt(r.height, o), width: lt(r.width, o) });
      !(function (e) {
        n.util.assert(Re.indexOf(e) >= 0, function () {
          return (
            "outputStride of " + e + " is invalid. It must be either 8 or 16."
          );
        });
      })(t.outputStride),
        (function (e, t) {
                  ...
                  return (
                    ...
                    null == e
                      ...
                      : ((this.maxPoses = i.maxPoses),
                        ...
                        1 !== this.maxPoses
                          ? [3, 2]
                          : [4, rt(m, c, this.outputStride)])
                  );
                case 1:
                  return (g = l.sent()), (y = [g]), [3, 4];
                case 2:
                  return [
                    4,
                    et(
            ...
            case 0:
              return "ResNet50" !==
                (t = (function (e) {
                  var t = e || Fe;
                  if (
                    (null == t.architecture && (t.architecture = "MobileNetV1"),
                  ...
                  if (
                    (null == t.inputResolution &&
                      (t.inputResolution = { height: 257, width: 257 }),
                ...
                : ((l = t.outputStride),
                  ...
                  (n =
                    4 === u ? at + "float/" + h : at + "quant" + u + "/" + h),
                  [4, i.loadGraphModel(t.modelUrl || n)]);
            case 1:
              return (r = a.sent()), [2, new ut(r, t)];
            case 2:
              return (
                (o = (function (e, t, i) {
  ...
  var ct = { keypointsToNormalizedKeypoints: _ },
    pt = {
      modelType: {
          ...
          switch (t) {
            ...
            case e.SupportedModels.BlazePose:
              if (((r = void 0), null != (n = i))) {
                if ("tfjs" === n.runtime) return [2, le(i)];
                if ("mediapipe" === n.runtime) return [2, g(i)];
                r = n.runtime;
              }
              throw new Error(
                "Expect modelConfig.runtime to be either 'tfjs' or 'mediapipe', but got " +
                  r
              );
            case e.SupportedModels.MoveNet:
              return [2, _e(i)];
